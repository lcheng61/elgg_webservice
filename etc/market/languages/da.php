...
$danish = array(
	...
	'market:user:title' => "%s's Marked",
	'market:user' => "%s's annoncer",
	'market:user:friends' => "%s's venners Marked",
	'market:user:friends:title' => "%s's venners Marked",
...
',
	...
	'market:widget:description' => "Fremvis Marked",
	...
	// market river
	'river:create:object:market' => '%s oprettede en annonce på Det Marked med titlen %s',
	'river:update:object:market' => '%s opdaterede annoncen %s i Markedet',
